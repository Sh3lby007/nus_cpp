...
void testIntLL();
void testFoodOpLessThan();
void testFoodSort();
void testReverseOp();
void testFoodExist();
void testFoodAddition();
void testIntLLExtractMin();
...
/*
	cout << endl << "Here is the sorted list of number in ascending order" << endl;
	while (!l.empty())
		cout << l.extractMin() << " " ;
	cout << endl;
...
void testIntLLExtractMin()
{
	...
	cout << endl << "Testing Extract Minimum for List<int>" << endl;
	...
	cout << endl << "After one extractMin()" << endl;
	l.extractMin();
	l.print(false);

	cout << endl << "After another one extractMin()" << endl;
	l.extractMin();
	l.print(false);
...
void testFoodSort()
{
	cout << endl << "Testing extractMin() for class Food" << endl;
	List<Food> l_food;
	...
	cout << endl << "The sorted list of food in ascending order is: " << endl;
	// uncomment this code after you finished extractHead()
	/*
	while (!l_food.empty())
		cout << l_food.extractMin() << endl;
*/
	cout << endl;
}
