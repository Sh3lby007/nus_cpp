...
void make_appointment(Appointment& newApt, string description, int year,
                      int month, int day, int startHour, int startMinute,
...
int main() {
  ...
  // cout << "Date compare result = " << compare_date(dateOne, dateTwo) << endl;
  // // Should be 0
  ...
  cout << "Time compare result = " << compare_time(timeOne, timeTwo)
       << endl;  // Should be -1
